...
class StartStopComponent(Node):
    ...
    def _initialize_control_airspyhf_channelizer_publisher(self):
        ...
        self._control_airspyhf_channelizer_publisher = self.create_publisher(
            DiagnosticArray,
            'control_airspyhf_channelizer_subprocess',
            self._queue_size_)
        self.get_logger().info(
            "Control publisher is now publishing to the 'control_airspyhf_channelizer_subprocess' topic.")
